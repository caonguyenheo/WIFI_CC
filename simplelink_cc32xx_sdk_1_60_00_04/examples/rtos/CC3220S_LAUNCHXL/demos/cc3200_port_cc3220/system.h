...
//  |1 byte flicker|1 byte flip updown|1 byte flip leftright|2 bytes bitrate|1 byte frame rate|2 byte resolutions|1 byte reboot after register|1 byte speaker volume|1 byte microphone volume|1 byte GOP|1 byte DUPLEX|1 byte auto bitrate|1byte AGC on/off
#define CAM_SETTING_DEFAULT {FLICKER_DEFAULT,IMAGEFLIP_UD_DEFAULT,IMAGEFLIP_LR_DEFAULT,BITRATE_DEFAULT>>8,BITRATE_DEFAULT&0xff,FRAMERATE_DEFAULT,RESOLUTION_DEFAULT>>8,RESOLUTION_DEFAULT&0xff,UPGRADE_DEFAULT,SPK_VOL_DEFAULT,MIC_VOL_DEFAULT,GOP_DEFAULT,AUDIO_DUPLEX_DEFAULT,AUTO_BITRATE_DEFAULT,AUDIO_AGC_DEFAULT,0,0,0,0,0}
