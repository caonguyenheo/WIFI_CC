 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /media/sf_new_cc3220_60/simplelink_cc32xx_sdk_1_60_00_04/kernel/tirtos/builds/CC3220SF_LAUNCHXL/debug/ccs/package/cfg/debug_pem4");
...
{
    return (xdc_runtime_Memory_HeapProxy_Handle)ti_sysbios_heaps_HeapTrack_create((const ti_sysbios_heaps_HeapTrack_Params *)__prms, __eb);
}
    ...
    xdc_runtime_Error_Block *__eb)
{
    ...
    /* common instance initialization */
    __obj = xdc_runtime_Core_createObject__I(&ti_sysbios_heaps_HeapTrack_Object__DESC__C, NULL, &__prms, (xdc_CPtr)__paramsPtr, 0, __eb);
    if (__obj == NULL) {
        return NULL;
    }
